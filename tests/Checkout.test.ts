...
const productData: ProductData = {
  async getProduct(idProduct: number): Promise<any> {
    const products: { [idProduct: number]: any } = {
      1: { idProduct: 1, description: "A", price: 10, width: 10, height: 10, length: 10, weight: 0.9 },
      2: { idProduct: 2, description: "B", price: 20, width: 100, height: 30, length: 10, weight: 3 },
      3: { idProduct: 3, description: "C", price: 30, width: 200, height: 100, length: 50, weight: 40 },
